...
<body>
    ...
    <main class="bg-dark">
        @foreach ($Oss as $os)
            <form action="" id="formulario" enctype="multipart/form-data" class="text-white pb-2">
                ...
                <div class="col-1 form-group row mx-auto">
                    <a href="/pdfDeOs/{{ $os->manutencao_id }}">
                        <button class="btn btn-primary" id="imprime">Imprimir</button>
                    </a>
